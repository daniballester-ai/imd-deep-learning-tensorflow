# 🧠 Aprendizado Profundo — Atividade 02
...
Atividade 02 da disciplina, composta por 3 tarefas que percorrem o caminho de MLPs (hiperparâmetros) até CNNs aplicadas a um caso real de reconhecimento de caracteres manuscritos.

## 📌 Tarefas

### 1️⃣ [Estudo Dirigido: TensorFlow Playground](tarefa-1-playground-tensorflow/README.md) ✅
...
### 2️⃣ Otimizar MNIST com Optuna ⏳ *(em andamento)*
...
Versão publicada (somente outputs, sem artefatos de planejamento): [github.com/daniballester-ai/imd-deep-learning-tensorflow](https://github.com/daniballester-ai/imd-deep-learning-tensorflow)
